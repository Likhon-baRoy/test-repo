...
My heart whelming Thanks to you guy's, who put all their effort to make Emacs go one-step further.
...
And many other people from internet world.
...
- Install [[https://github.com/googlefonts/noto-emoji][emoji font]] (*Noto Emoji*) for Linux
